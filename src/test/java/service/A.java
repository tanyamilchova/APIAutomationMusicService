...
public class A {
        ...
        private final Logger logger = LoggerFactory.getLogger(service.AbstractService.class);
        ...
        public <T> ResourceResponse <T> updateResource(T resource, String endpoint, long resourceId){
            ...
            try {
                ...
                if(isNotFoundResource(response, endpoint,resourceId)){
                    throw new ResourceException("Resource: "+ resource + " ID: " + resourceId +" is not found");
                }
